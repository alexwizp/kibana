...
search: {
    esSearch: {
        ...
        toKibanaSearchResponse: <SearchResponse_3 extends import("../common").IEsRawSearchResponse<any> = import("../common").IEsRawSearchResponse<any>, KibanaResponse_1 extends import("../common").IKibanaSearchResponse<any> = import("../common").IKibanaSearchResponse<SearchResponse_3>>() => import("rxjs").OperatorFunction<import("@elastic/elasticsearch").ApiResponse<SearchResponse_3, import("@elastic/elasticsearch/lib/Transport").Context>, KibanaResponse_1>;
